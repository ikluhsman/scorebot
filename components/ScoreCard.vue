<template>
    <div class="mt-12 flex flex-col items-center">
        <score-board :key="'scoreBoard'" :players="players" :goal="goal" :game="game" :datetime="datetime" :leaders="getLeaders" @changeGoal="changeGoal"/>
        <div class="w-5/6 flex justify-center px-2">
            <player-score-card v-for="(p, k) in players" :ref="'playerScoreCard' + k" :key="k"  :player="p" :player-index="k" :goal="goal" @totalsUpdated="updatedCardTotals"/>
        </div>
    </div>
</template>
<script>
